...
const DATA: Data = {
  ...
  skills: [
    ...
    { label: "Frontend",     value: "React, Next.js, React Native, Tailwind CSS, MUI, Chakra UI" },
    { label: "Backend",      value: "Node.js, Laravel, Spring Boot, REST APIs, WebSockets, GraphQL" },
    { label: "Data",         value: "PostgreSQL, MySQL, MongoDB, Redis, Databricks" },
    { label: "Testing",      value: "Jest, Vitest" },
    { label: "Infra & Tools", value: "Docker, Kubernetes, NGINX, AWS (EC2, S3, RDS, Lambda), Firebase, Vercel" },
  ],
  languages: [
  ...
  experience: [
    {
      ...
      period:  "2025 – now",
      bullets: [
        "Architected and launched a multi-tenant carer platform (API + React app), handling 2,000 real-time scheduling events/min across 1,000–2,000 active users.",
        "Optimized queries on 10M+ row tables using indexing and query refactoring, reducing execution time from minutes to <2s.",
        "Identified excessive re-renders in React and implemented memoization and request deduplication, eliminating 50–100 unnecessary API calls/min and reducing backend load by ~60%.",
        "Mentored 10+ engineers through structured onboarding, documentation, and code reviews, reducing ramp-up time from ~2 weeks to 3–4 days.",
        "Owned production stability, resolving 50+ incidents and implementing fixes that reduced weekly escalations by ~50%.",
      ],
    },
    {
      ...
      period:  "2022 – 2024",
      bullets: [
        "Led migration of legacy PHP/jQuery monolith to Laravel + React, modernizing architecture and reducing page load times from 5–10 min to <5s.",
        "Delivered 100+ production features in React, improving user workflows across a multi-tenant platform and maintaining pixel-perfect UI consistency.",
        "Developed automated reporting pipelines (SQL + backend APIs) used by 20+ clients, saving 5–10 hours/week per client and eliminating manual data processing.",
      ],
    },
  ],
  ...
  projects: [
    {
      ...
      desc:  "Contributed to a Chrome extension with 400,000+ users, shipping UI and feature improvements and collaborating with maintainers on production-grade code reviews.",
    },
    {
      name:  "Rosindex",
      type:  "ROS Index",
      ...
      desc:  "Implemented and automated structured GitHub issue forms, improving bug report quality and helping resolve 200+ issues by streamlining triage.",
    },
  ],
};
